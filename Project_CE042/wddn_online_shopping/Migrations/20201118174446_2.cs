    ...
    public partial class _2 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameIndex(
                ...
                table: "item_Details",
                newName: "IX_item_Details_seller_id1");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    seller_shop_address = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    total_pricer = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_item_Details_sellers_seller_id1",
                table: "item_Details",
                column: "seller_id1",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameColumn(
                name: "seller_id1",
                table: "item_Details",
                newName: "seller_detailseller_id");

            migrationBuilder.RenameIndex(
                name: "IX_item_Details_seller_id1",
                table: "item_Details",
                newName: "IX_item_Details_seller_detailseller_id");
